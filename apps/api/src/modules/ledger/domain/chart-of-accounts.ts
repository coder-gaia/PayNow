...
export const CHART_OF_ACCOUNTS: readonly AccountDefinition[] = [
  {
    ...
    description: 'O que os clientes já devem por faturas emitidas e ainda não pagas.',
  },
  {
    ...
    description: 'Dinheiro já capturado pelo gateway e ainda não repassado ao merchant.',
  },
  {
    ...
    description: 'O que o merchant ganhou, reconhecido na emissão da fatura.',
  },
  {
    ...
    description: 'A parte do Paynow em cada transação, descontada do que o merchant recebe.',
  },
  {
    ...
    description: 'Saldo a favor do cliente, gerado por downgrade ou estorno parcial.',
  },
  {
    ...
    normalBalance: 'debit',
    label: 'Estornos',
    description: 'O que foi devolvido ao cliente, abatido da receita do merchant.',
  },
];
